...
AvgVelocity_cstr = NlpFunction('Name',AvgVelocity_fun.Name,...
    'Dimension',2,...
    'lb',bounds.Flight.constrBounds.AvgVelocity.lb, ...
    'ub',bounds.Flight.constrBounds.AvgVelocity.ub,...
    'Type','Nonlinear',...
...
%     'Dimension',2,...
%     'lb',bounds.Flight.constrBounds.SwDifference.lb, ...
%     'ub',bounds.Flight.constrBounds.SwDifference.ub,...
%     'Type','Linear',...
...
%     'Dimension',2,...
%     'lb',bounds.Flight.constrBounds.ExtDifference.lb, ...
%     'ub',bounds.Flight.constrBounds.ExtDifference.ub,...
%     'Type','Linear',...
