...
if isempty(load_path)
    % evaluate the inertia matrix, the coriolis term, and the gravity vector
...
%% Define domains
% rabbit model; r_stance domain; r_impact guard;
% Add contact point to the right toe, add height to the left toe
