function [nlp] = multi_domain_constraints(nlp, bounds)
    ...
    AvgVelocity_cstr = NlpFunction('Name',AvgVelocity_fun.Name,...
        'Dimension',2,...
        'lb',bounds.FrontStance.constrBounds.AvgVelocity.lb, ...
        'ub',bounds.FrontStance.constrBounds.AvgVelocity.ub,...
        'Type','Nonlinear',...
        'SymFun',AvgVelocity_fun,...
        'DepVariables',[T1_var,T3_var,T5_var,T7_var,x0_var,xf_var]);
    
    addConstraint(nlp.Phase(1), 'AvgVelocity', 'first', AvgVelocity_cstr);
end
