...
% foot clearance
opt.constraint.foot_falling(nlp, bounds, left_front_foot_frame);
opt.constraint.foot_falling(nlp, bounds, right_front_foot_frame);
opt.constraint.foot_rising(nlp, bounds, right_back_foot_frame);
opt.constraint.foot_rising(nlp, bounds, left_back_foot_frame);
