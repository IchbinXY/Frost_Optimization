function bounds = GetBounds2(model, vel, T)
    ...
    model_bounds.params.pRightBackFoot.lb = [0, 0, 0, 0];
    model_bounds.params.pRightBackFoot.ub = [0, 0, 0, 0];
    
    model_bounds.params.pLeftBackFoot.lb = [0, 0, 0, 0];
    model_bounds.params.pLeftBackFoot.ub = [0, 0, 0, 0];
    ...
    bounds.RightStance.inputs.ConstraintWrench.fRightBackFoot.lb = [-1000,-1000,300,-1000]';
    bounds.RightStance.inputs.ConstraintWrench.fRightBackFoot.ub = [1000,1000,1000,1000]';
    bounds.RightStance.inputs.ConstraintWrench.fLeftBackFoot.lb = [-1000,-1000,300,-1000]';
    bounds.RightStance.inputs.ConstraintWrench.fLeftBackFoot.ub = [1000,1000,1000,1000]';
    ...
    bounds.LeftStance.inputs.ConstraintWrench.fRightBackFoot.lb = [-1000,-1000,300,-1000]';
    bounds.LeftStance.inputs.ConstraintWrench.fRightBackFoot.ub = [1000,1000,1000,1000]';
    bounds.LeftStance.inputs.ConstraintWrench.fLeftBackFoot.lb = [-1000,-1000,300,-1000]';
    bounds.LeftStance.inputs.ConstraintWrench.fLeftBackFoot.ub = [1000,1000,1000,1000]';
