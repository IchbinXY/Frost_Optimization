...
% 
% load('inputs\vel_07_Inputs_to_VS_0006_FrontStance_restore6.mat')
% figure(1); hold on; grid on
% plot3(0.7*ones(1,length(int_front_leg_pose)), 1:34, int_front_leg_pose(:,1)*180/pi, 'linewidth',2)
% legend('original opt', 'restored6 opt')
% figure(2); hold on; grid on
% plot3(0.7*ones(1,length(int_front_leg_pose)), 1:34, int_front_leg_pose(:,2)*180/pi, 'linewidth',2)
% legend('original opt', 'restored6 opt')
% figure(3); hold on; grid on
...
% legend('original opt', 'restored6 opt')
% 
% load('inputs\vel_07_Inputs_to_VS_0006_BackStance_restore6.mat')
% figure(4); hold on; grid on
% plot3(0.7*ones(1,length(int_back_leg_pose)), 1:35, int_back_leg_pose(:,1)*180/pi, 'linewidth',2)
% legend('original opt', 'restored6 opt')
% figure(5); hold on; grid on
% plot3(0.7*ones(1,length(int_back_leg_pose)), 1:35, int_back_leg_pose(:,2)*180/pi, 'linewidth',2)
% legend('original opt', 'restored6 opt')
% figure(6); hold on; grid on
% plot3(0.7*ones(1,length(int_back_leg_pose)), 1:35, int_back_leg_pose(:,3)*180/pi, 'linewidth',2)
% legend('original opt', 'restored6 opt')
% 
% load('inputs\vel_07_Inputs_to_VS_0006_FrontStance.mat')
% figure(1); hold on; grid on
% plot3(0.7*ones(1,length(int_front_leg_pose)), 1:34, int_front_leg_pose(:,1)*180/pi, 'linewidth',2)
% figure(2); hold on; grid on
% plot3(0.7*ones(1,length(int_front_leg_pose)), 1:34, int_front_leg_pose(:,2)*180/pi, 'linewidth',2)
...
% plot3(0.7*ones(1,length(int_front_leg_pose)), 1:34, int_front_leg_pose(:,3)*180/pi, 'linewidth',2)
% 
% load('inputs\vel_07_Inputs_to_VS_0006_BackStance.mat')
% figure(4); hold on; grid on
% plot3(0.7*ones(1,length(int_back_leg_pose)), 1:35, int_back_leg_pose(:,1)*180/pi, 'linewidth',2)
% figure(5); hold on; grid on
% plot3(0.7*ones(1,length(int_back_leg_pose)), 1:35, int_back_leg_pose(:,2)*180/pi, 'linewidth',2)
