...
%     func_name = nlp.Phase(i).ConstrTable.Properties.VariableNames';
%     for j = 2:length(func_name)
%         removeConstraint(nlp.Phase(i), func_name{j});
%     end
% end
% 
% for i = 2:length(nlp.Phase)
%     func_name = nlp.Phase(i).CostTable.Properties.VariableNames';
%     for j = 1:length(func_name)
%         removeCost(nlp.Phase(i), func_name{j});
%     end
% end
% 
% nlp.update();
