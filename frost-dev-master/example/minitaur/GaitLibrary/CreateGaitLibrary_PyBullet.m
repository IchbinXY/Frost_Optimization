...
GaitLibrary.FrontStance.HAlpha = zeros(8, 6, length(velocity));
GaitLibrary.BackStance.HAlpha  = zeros(8, 6, length(velocity));
GaitLibrary.FrontStance.MotorAngle = zeros(8, 21, length(velocity));
GaitLibrary.BackStance.MotorAngle  = zeros(8, 21, length(velocity));
GaitLibrary.FrontStance.LegPose = zeros(8, 21, length(velocity));
GaitLibrary.BackStance.LegPose  = zeros(8, 21, length(velocity));
