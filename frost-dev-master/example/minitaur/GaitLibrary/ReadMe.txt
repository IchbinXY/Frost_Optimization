...
Output contains (all phases, stride time normalized), Zhenyu's version. 
PyBullet is for importing to controller (stance phase, stance phase normalized), my version